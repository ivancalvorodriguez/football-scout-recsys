...
from src.similitud.config import MODELOS_SERVIBLES
...
class TestProductoCartesiano:
    ...
    def test_fijar_una_flag_la_recorta(self) -> None:
        ...
        assert combinaciones == [("equipo", "2", "por_liga"), ("equipo", "2", "global")]
...
class TestServibles:
    ...
    def test_cada_entidad_con_su_receta(self) -> None:
        for entidad, formulacion, normalizacion in _combinaciones(_args(servibles=True)):
